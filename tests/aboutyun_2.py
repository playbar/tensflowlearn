...
with tf.Session() as sess:
    ...
    for i in range(len(test_list_of_values)):
        ...
        print ("Test N° ", i,"Predicted Class: ", np.argmax(train_list_values[nn_index]), "True Class: ", np.argmax(test_list_of_values))
        if np.argmax(train_list_values[nn_index]) == np.argmax(test_list_of_values):
